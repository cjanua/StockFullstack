...
def get_trading_account(*args) -> Dict[str, Any]:
    ...
    from stock_fullstack.common.sdk.loaders import get_account  # Import inside function
...
def get_trading_positions(*args) -> Dict[str, Any]:
    ...
    from stock_fullstack.common.sdk.loaders import get_positions  # Import inside function
    return handle_response(get_positions)

@registry.register('trading', 'assets')
def get_trading_assets(*args) -> Dict[str, Any]:
    """Get list of assets"""
    from stock_fullstack.common.sdk.loaders import get_assets  # Import inside function
...
def get_account_history(args: CommandContext, ctx) -> Dict[str, Any]:
    """Get account history"""
    from stock_fullstack.common.sdk.loaders import get_portfolio_history  # Import inside function
    days = args.days or 7
...
def get_account_watchlists(*args) -> Dict[str, Any]:
    ...
    from stock_fullstack.common.sdk.loaders import get_watchlists  # Import inside function
    return handle_response(get_watchlists)

@registry.register('trading', 'assets', 'search')
def search_assets(args, ctx) -> Dict[str, Any]:
    """Search assets"""
    from stock_fullstack.common.sdk.loaders import query_asset  # Import inside function
    query = args.query
    if not query:
        return {
            "error": True,
